"""Mock authentication module for BICAM - for testing purposes."""
...
CREDENTIAL_ENDPOINT = "https://mock-endpoint.com/get-credentials"
...
def _fetch_credentials() -> Dict[str, Any]:
    ...
    try:
        ...
        raise Exception(f"Failed to connect to credential server: {str(e)}") from e
    except (KeyError, json.JSONDecodeError) as e:
        raise Exception(f"Invalid response from credential server: {str(e)}") from e
